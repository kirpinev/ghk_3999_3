      ...
      {step === 4 && (
        <>
          <div className={thxSt.container}>
            ...
            <Gap size={12} />
            <Typography.Text tag="p" view="primary-medium" color="secondary">
              Подберём для вас комфортную кредитную нагрузку. Не выходите из
              приложения, чтобы не оформлять всё с начала
            </Typography.Text>
            <Gap size={20} />
          </div>
        </>
      ...
      {step === 5 && (
        <>
          <div className={thxSt.container}>
            ...
            <Gap size={12} />
            <Typography.Text tag="p" view="primary-medium" color="secondary">
              Максимальная сумма, которую сможем одобрить. Не выходите из
              приложения, чтобы не оформлять всё с начала
            </Typography.Text>
            <Gap size={20} />
          </div>
          ...
          <ButtonMobile
            onClick={() => {
              if (!LS.getItem(LSKeys.ClickFirstStep, false)) {
                window.gtag("event", "3999_next_click_step1_var3", {
                  variant_name: "ghk_3999_3",
                });
            ...
            onClick={() => {
              ...
              sendDataToGA({
                ...
                if (!LS.getItem(LSKeys.ClickSecondStep, false)) {
                  window.gtag("event", "3999_next_click_step2_var3", {
                    variant_name: "ghk_3999_3",
                  });
