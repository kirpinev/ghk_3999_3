export const enum LSKeys {
  ShowThx = "ab_show_thx_ghk_3999_3",
  ShowThanks = "ab_show_thanks_ghk_3999_3",
  ClickFirstStep = "ab_click_first_step_ghk_3999_3",
  ClickSecondStep = "ab_click_second_step_ghk_3999_3",
}
